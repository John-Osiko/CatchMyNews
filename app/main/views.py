...
def sourceArticles(id):
    ...
    source = id
    return render_template('news_source.html', articles = all_articles, source = source)
...
def NewsArticles():
    ...
    return render_template('news.html',politics=politics_articles, tech =education_articles)
